...
\newline
La ecuación \ref{Ecu_h_lopez} es la forma general en que se puede obtener $h$. Por lo tanto, el Nusselt es el parámetro adimensional que describe como es la relación entre la transferencia de calor por convección y conducción. A continuación se en listan las ecuaciones para calcular el Nusselt para diferentes regímenes de flujo:
